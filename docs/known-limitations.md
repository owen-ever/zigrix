...
- config path is intentionally fixed to `~/.zigrix/zigrix.config.json`; richer diagnostics may still be added, but layered config discovery is not part of the contract
